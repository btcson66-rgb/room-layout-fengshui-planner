...
check('review-ready-count', reviewReadyBlogSlugs.size === 4, reviewReadyBlogSlugs.size);
check('held-count', heldSlugs.length === markdownFiles.length - 4, heldSlugs.length);
