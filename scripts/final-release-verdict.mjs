...
requirePass('sitemap URL count', seo.sitemapUrlCount === 1447 && seo.expectedSitemapUrlCount === 1447);
...
requirePass('production sitemap count', sitemap.count === 1447 && sitemap.expectedCount === 1447);
