...
export const hubContent: Record<string, HubContent> = {
  ...
  bedroom: {
    ...
    faq: [
      { q: '床邊要留多少走道？', a: '約 60 公分可作為一般房間的初步規劃起點；雙人床兩側是否都需要通道，取決於實際上下床方式。仍須核對身形、換床單、門片和無障礙需求，不把單一數字視為通用底線。' },
  ...
  'room-planning': {
    lead: [
      ...
      '走道寬度是整個主題的核心數字。約 60 公分可作為一般房間的初步規劃起點，較頻繁使用的通道可考慮更寬；真正需要的寬度仍取決於使用者、門片、抽屜、椅子與當地適用規範。',
    ],
    coreQuestions: [
