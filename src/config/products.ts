...
export const movingOsProduct = {
  ...
  /** Product JSON-LD artwork. Google Merchant listings require `image`, and it
   * wants 16:9, 4:3 and 1:1 of the same product. Generated by
   * `npm run assets:products`; shared by the English and Chinese pages. */
  coverImages: [
    '/assets/moving-new-home-os/cover-16x9.png',
    '/assets/moving-new-home-os/cover-4x3.png',
    '/assets/moving-new-home-os/cover-1x1.png',
  ],
} as const;
...
export const layoutVaultProduct = {
  ...
  /** See `movingOsProduct.coverImages`. */
  coverImages: [
    '/assets/small-space-layout-vault/cover-16x9.png',
    '/assets/small-space-layout-vault/cover-4x3.png',
    '/assets/small-space-layout-vault/cover-1x1.png',
  ],
} as const;
